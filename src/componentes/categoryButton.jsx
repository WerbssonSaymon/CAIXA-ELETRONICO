    ...
    <>
        <h2 className="text-center">Escolha as categorias</h2>
            <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
              ...
              <label className="btn btn-outline-light" htmlFor="btncheck1">Matematica</label>
              ...
              <label className="btn btn-outline-light" htmlFor="btncheck2">Portugues</label>
              ...
              <label className="btn btn-outline-light" htmlFor="btncheck3">Ciencia</label>
              ...
              <label className="btn btn-outline-light" htmlFor="btncheck4">Historia</label>
              ...
              <label className="btn btn-outline-light" htmlFor="btncheck5">Geografia</label>
            </div>
    </>
  )
}
